...
func renderEmptyView(width, height int) string {
	...
	content := strings.Join([]string{
		...
		"$ vdash add /path/to/project",
		"",
		"Or from a project directory:",
		"$ cd my-project && vdash add .",
		"",
...
func renderHelpOverlay(width, height int, cfg *ports.Config) string {
	...
	content := strings.Join([]string{
		...
		"",
		"Actions",
		"Enter    View logs (latest session)",
		"L        View logs (pick session)",
		"Shift+\u21b5 View logs (pick session)",
		...
		"gg       Jump to top (double 'g')",
		"Ctrl+D   Half-page down",
		"Ctrl+U   Half-page up",
		"/        Search logs",
		"n/N      Next/prev match",
		"S        Pick different session",
		"q/Esc    Return to project list",
		"",
		"General",
		"?        Show this help",
		"q        Quit",
